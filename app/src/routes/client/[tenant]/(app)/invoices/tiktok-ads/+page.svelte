...
<div class="space-y-6">
	<div>
		...
		<p class="text-muted-foreground">Rapoartele tale de cheltuieli TikTok Ads</p>
	</div>
	...
	{:else if spending.length === 0}
		<div class="rounded-md border p-8 text-center">
			<p class="text-muted-foreground">Nu sunt rapoarte de cheltuieli TikTok Ads disponibile.</p>
		</div>
	{:else}
	...
	{#if invoiceDownloads.length > 0}
		<div class="pt-4">
			<div class="mb-4">
				<h2 class="text-xl font-semibold">Facturi PDF TikTok</h2>
				<p class="text-sm text-muted-foreground">Facturile oficiale descărcate din TikTok Business Center</p>
			</div>
				...
				<Table>
					...
					<TableBody>
						{#each invoiceDownloads as dl}
							<TableRow>
								<TableCell>
									<div class="font-medium">{dl.adAccountName || dl.tiktokAdvertiserId}</div>
								</TableCell>
