<script lang="ts">
	import { getClientAdAccount, getMetaCampaignInsights, getMetaActiveCampaigns } from '$lib/remotes/reports.remote';
	...
	// Client ad account
	const adAccountQuery = $derived(getClientAdAccount(clientId));
