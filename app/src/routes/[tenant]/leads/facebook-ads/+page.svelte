<script lang="ts">
	...
	import { getLeads, triggerLeadSync, updateLeadStatus } from '$lib/remotes/leads.remote';
	...
	{:else if leads.length === 0}
		<div class="flex flex-col items-center justify-center py-12 text-center">
			...
			<p class="text-sm text-muted-foreground mt-1">
				{search || statusFilter ? 'Încearcă alte filtre' : 'Apasă "Sync Now" pentru a importa leaduri din Facebook'}
			</p>
		</div>
	{:else}
