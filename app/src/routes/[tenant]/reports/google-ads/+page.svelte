<script lang="ts">
	import { getGoogleReportAdAccounts, getGoogleCampaignInsights, getGoogleActiveCampaigns, getGoogleAdGroupInsights, getGoogleConversionActions, getGoogleCampaignConversionActions } from '$lib/remotes/google-reports.remote';
	...
	import {
		...
		type GoogleCampaignAggregate, type GoogleAdGroupAggregate, type GoogleTotals
	...
	const accountsQuery = getGoogleReportAdAccounts();
	...
	// Auto-switch preset when channel filter changes
	$effect(() => {
