<script lang="ts">
	import { getGoogleAdsInvoices, deleteGoogleAdsInvoice, triggerGoogleAdsSync } from '$lib/remotes/google-ads-invoices.remote';
...
<div class="space-y-6">
	<div class="flex items-center justify-between">
		<div>
			...
			<p class="text-muted-foreground">Facturile descărcate din Google Ads pentru toți clienții</p>
		</div>
	...
	{:else if invoices.length === 0}
		<div class="rounded-md border p-8 text-center">
			<p class="text-muted-foreground">Nu sunt facturi Google Ads sincronizate.</p>
		</div>
	{:else}
