...
import { goto } from '$app/navigation';
	...
	let recurringTaxRate = $state(String(DEFAULT_VAT_PERCENT));
	...
	function openRecurringDialog(recurringInvoiceId?: string) {
		if (recurringInvoiceId) {
			...
			if (ri) {
				...
				recurringTaxRate = String(invoiceVatPercentFromBps(ri.taxRate));
			...
			recurringServiceId = '';
			recurringAmount = '';
			recurringTaxRate = String(DEFAULT_VAT_PERCENT);
