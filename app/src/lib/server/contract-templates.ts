...
/**
 * Returns the default contract clauses (sections 4-23) for a
 * "Contract de Prestări Servicii Informatice".
 *
 * Sections 1-3 are generated dynamically from contract data in the PDF
 * generator and are NOT included here.
 *
 * Placeholders used:
 *   {contractDurationMonths}  – minimum contract duration in months
 *   {penaltyRate}             – penalty percentage rate
 *   {prestatorEmail}          – provider e-mail for notifications
 *   {beneficiarEmail}         – beneficiary e-mail for notifications
 *   {hourlyRate}              – hourly rate amount
 *   {hourlyRateCurrency}      – currency for the hourly rate
 *   {contractDate}            – date the contract was signed
 *   {tenantName}              – legal name of the service provider
 */
