<script lang="ts">
	...
	// basePath = rădăcina modulului; homeHref = breadcrumb acasă. Când switch-ul admin
	// „Acces AI" e ON, clientul are acces COMPLET (aceleași tab-uri ca adminul); accesul
	// e impus server-side de remote-uri (gate per-website), nu de UI.
