	...
	return {
		...
		async adapt(builder: Builder) {
			...
			if (builder.hasServerInstrumentationFile?.()) {
				entrypoints['instrumentation.server'] = `${tmp}/instrumentation.server.js`;
			}
			...
			builder.copy(files, out, {
				replace: {
					...
					BUILD_OPTIONS: `{ serveAssets: ${serveAssets}, precompress: ${precompress}, isr: ${isr} }`
				}
			});
